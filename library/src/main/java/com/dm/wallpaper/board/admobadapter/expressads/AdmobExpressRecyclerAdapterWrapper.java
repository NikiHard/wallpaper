...
package com.dm.wallpaper.board.admobadapter.expressads;
...
import com.dm.wallpaper.board.admobadapter.AdViewHelper;
import com.dm.wallpaper.board.admobadapter.AdapterWrapperObserver;
import com.dm.wallpaper.board.admobadapter.AdmobAdapterCalculator;
import com.dm.wallpaper.board.admobadapter.AdmobFetcherBase;
   ...
   */
    ...
    */
    ...
    public class Builder{
         ...
         */
        public Builder setAdapter(RecyclerView.Adapter<LatestAdapter.ViewHolder> adapter) {
            mAdapter = adapter;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if(viewHolder.getItemViewType() == getViewTypeAdExpress()) {
            ...
            mAdapter.onBindViewHolder((LatestAdapter.ViewHolder) viewHolder, origPos);
        }
    }
