    ...
    protected Boolean doInBackground(Void... voids) {
        while (!isCancelled()) {
            try {
                ...
                Language language = LocaleHelper.getCurrentLanguage(mContext.get());
                //URL lang = new URL(language.getName());
                //"https://porting-team.ru/wallpaper-api/?format=json.json&lang=";
                Uri.Builder builder = new Uri.Builder();
                builder.scheme("https")
                        .authority("porting-team.ru")
                        .appendPath("wallpaper-api")
                        .appendQueryParameter("format", "json.json")
                        .appendQueryParameter("lang", language.getName());
