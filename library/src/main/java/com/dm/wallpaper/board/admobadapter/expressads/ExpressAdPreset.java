...
public class ExpressAdPreset {
    private static final String UNIT_ID_DEFAULT_EXPRESS = "ca-app-pub-8676713254153441/1386164407";
    private static final AdSize SIZE_DEFAULT_EXPRESS = new AdSize(AdSize.FULL_WIDTH, 250);
